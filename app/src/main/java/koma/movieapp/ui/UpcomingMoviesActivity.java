...
public class UpcomingMoviesActivity extends BaseActivity implements MoviesFragment.Callbacks {
    private static final String TAG = makeLogTag(UpcomingMoviesActivity.class);

    // How is this Activity being used?
    private static final int MODE_UPCOMING = 0; // as top-level "Home" screen
    private int mMode = MODE_UPCOMING;
...
//    }
    ...
    protected int getSelfNavDrawerItem() {
        ...
        return mMode == MODE_UPCOMING ? NAVDRAWER_ITEM_UPCOMING : NAVDRAWER_ITEM_INVALID;
    }
    ...
    protected void onPostCreate(Bundle savedInstanceState) {
        ...
        if (mMoviesFrag != null && savedInstanceState == null) {
            ...
            args.putString("title", "Upcoming Movies");
            args.putInt("queryType", Config.UPCOMING_TOKEN);
...
//        Toolbar toolbar = getActionBarToolbar();
//        if (mMode != MODE_UPCOMING || mSpinnerConfigured || mTagMetadata == null || toolbar == null) {
